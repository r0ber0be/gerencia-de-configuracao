...
var dataChart = document.getElementById("chart_line").getAttribute("data");
var objChart = JSON.parse(dataChart);
/* large line chart */
var chLine = document.getElementById("chLine");
var chartData = {
  labels: objChart.labels,
  datasets: [{
    data: objChart.datasets.data,
...
/* bar chart */
var dataChart = document.getElementById("chart_bar").getAttribute("data");
var objChart = JSON.parse(dataChart);
...
if (chBar) {
  ...
  type: objChart.type,
  data: {
    labels: objChart.data.labels,
    datasets: [{
      label: objChart.data.datasets.label,
      data: objChart.data.datasets.data,
      backgroundColor: colors[3]
    }],
  },
  options: {
